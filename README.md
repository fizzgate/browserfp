...
| 指标 | 数值 |
|---|---|
| 唯一指纹 | **80**（来自 317 个 target 名，按 13 个确定性字段去重） |
...
扫描结果（这些版本生产流量里没出现过），合计缺 13 个：

| 品牌 | 已发布版本数 | 缺 | 成因 |
|---|---|---|---|
| chrome | 83 | 71, 153 | 段内无实采 golden |
| chrome-mobile | 83 | 71, 153 | 同上 |
| firefox | 76 | 119, 121–122 | 段内 tls_client 1:1 平局 |
| firefox-mobile | 76 | 119, 121–122 | 同上（83–84、111 实采，145–153 派生已覆盖）|
